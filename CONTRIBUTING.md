...
Welcome to `zoqoder` contributor's guide.
...
If you experience bugs or general issues with `zoqoder`, please have a look
...
You can help improve `zoqoder` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`zoqoder` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `zoqoder`'s files. While this mechanism can
...
```
conda create -n zoqoder python=3 six virtualenv pytest pytest-cov
conda activate zoqoder
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/zoqoder.git
   cd zoqoder
   ```
...
5. Install [pre-commit]:
   ...
   `zoqoder` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/zoqoder
[issue tracker]: https://github.com/<USERNAME>/zoqoder/issues
